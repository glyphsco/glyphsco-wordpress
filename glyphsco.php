...
/* CREATE SETTINGS PAGE */
	...
	<link rel="stylesheet" href="<?php echo plugins_url(); ?>/glyphsco/plugin-styles.css" type="text/css" media="all" />
	
	<div class="wrap glyphsco">
				
		<div class="main-content col col-2">
			<h2><img src="<?php echo plugins_url() .'/glyphsco/img/glyphs-logo.png'; ?>" width="150"  alt="Glyphs.co Logo" /></h2>
